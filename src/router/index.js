...
let PresentClaim = () => import('../components/presentclaim/Present');
let PresentDeclaration = () => import('../components/presentdeclaration/Present');
let PresentLedger = () => import('../components/presentledger/Present');
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/PresentClaim',
        component: PresentClaim
      },
      {
        path: '/PresentDeclaration',
        component: PresentDeclaration
      },
      {
        path: '/PresentLedger',
        component: PresentLedger
      }
    ]
  }
];
